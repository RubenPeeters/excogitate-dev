      ...
      <div className="isolate  px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg leading-8 text-gray-600">
            Still left with burning questions? We are happy to elaborate.
          </p>
        </div>
        <form
          action="#"
              ...
              <div className="flex h-6 items-center">
                <Switch
                  ...
                  className={classNames(
                    agreed ? "bg-lime-600" : "bg-gray-200",
                    "flex w-8 flex-none cursor-pointer rounded-full p-px ring-1 ring-inset ring-gray-900/5 transition-colors duration-200 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-600"
                  )}
                >
